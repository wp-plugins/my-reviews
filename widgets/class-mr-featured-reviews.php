...
class MR_Featured_Reviews extends WP_Widget {
	 ...
	 * @return WP_Widget
	 */
	public function MR_Featured_Reviews() {
		add_action( 'save_post', array( $this, 'action_save_post' ) );
		$this->WP_Widget( false, __( 'My Reviews - Featured Reviews', 'my-reviews' ), array( 'description' => __( 'Displays featured reviews', 'my-reviews' ) ) );
	}
